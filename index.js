       let a = 0
        ...
        let z = [{
                ...
                path:"./Movie_Reservation/moneyHeist/MoneyHeist_seats.html",
                id: 1,
                type: "Adventure",
                click:false
            }, {
                ...
                path:"./Movie_Reservation/johnnyEnglish/johnnyEmglish_seats.html",
                id: 2,
                type: "Comedy",
                click:false
            }, {
                ...
                path:"./Movie_Reservation/jumanji/jumanji_seat.html",
                id: 11,
                type: "Adventure",
                click:false
            },{
                ...
                path:"./Movie_Reservation/avengers/avengers_seats.html",
                id: 12,
                type: "Action,Marvel",
                click:false
            },{
                ...
                path:"./Movie_Reservation/sanghChi/sanghChi_seats.html",
                id: 13,
                type: "Action,Marvel",
                click:false
            },{
                ...
                path:"./Movie_Reservation/eternals/eternals_seats.html",
                id: 14,
                type: "Action",
                click:false
            },{
                ...
                title:"Intersteller",
                img:"imgs_movies/img/A1JVqNMI7UL._SL1500_.jpg",
                id:29,
                type:"Sci-fi",
                click:false
            ...
            let homeData=[
                {
                    ...
                    path:"./Movie_Reservation/hitman/hitman_seats.html",
                    id:30,
                    type:"Action",
                    click:false
                }
        ...
        function searchMovie(movies,key) {
            ...
            let S_count=0
            const outDiv1=document.getElementById("search-container1")
            const outDiv2=document.getElementById("search-container2")
            
            const outDiv3=document.getElementById("search-container3")
            
            const outDiv4=document.getElementById("search-container4")
            
            const outDiv5=document.getElementById("search-container5")
      outDiv1.innerHTML="";
      outDiv2.innerHTML="";
      outDiv3.innerHTML="";
      outDiv4.innerHTML="";
          ...
          if(key===""||value.title.toLowerCase().includes(key.toLowerCase())|| value.type.toLowerCase().includes(key.toLowerCase())){
            ...
            inDiv2.innerHTML = `
                ...
                <a href="Movie_Reservation/moneyHeist/MoneyHeist_seats.html"><button
                        class="showsBook btn-primary">Book
                        Now</button></a>`
            outDiv1.appendChild(inDiv2)
            console.log(value)
          }else if(S_count>=4 && S_count<=7){
            S_count+=1
            const inDiv2 = document.createElement("div")
                inDiv2.className = "div2 p-2 movieItems"
                inDiv2.innerHTML = `
                    ...
                    <a href="Movie_Reservation/moneyHeist/MoneyHeist_seats.html"><button
                            class="showsBook btn-primary">Book
                            Now</button></a>`
                outDiv2.appendChild(inDiv2)
          }else if(S_count>=8 && S_count<=11){
            S_count+=1
            const inDiv2 = document.createElement("div")
                inDiv2.className = "div2 p-2 movieItems"
                inDiv2.innerHTML = `
                    ...
                    <a href="Movie_Reservation/moneyHeist/MoneyHeist_seats.html"><button
                            class="showsBook btn-primary">Book
                            Now</button></a>`
                outDiv3.appendChild(inDiv2)
          }else if(S_count>=12 && S_count<=15){
            S_count+=1
            const inDiv2 = document.createElement("div")
                inDiv2.className = "div2 p-2 movieItems"
                inDiv2.innerHTML = `
                    ...
                    <a href="Movie_Reservation/moneyHeist/MoneyHeist_seats.html"><button
                            class="showsBook btn-primary">Book
                            Now</button></a>`
                outDiv4.appendChild(inDiv2)
          }else if(S_count>=16 && S_count<=19){
            S_count+=1
            const inDiv2 = document.createElement("div")
                inDiv2.className = "div2 p-2 movieItems"
                inDiv2.innerHTML = `
